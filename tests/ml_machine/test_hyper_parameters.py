...
from aikit.ml_machine.hyper_parameters import (
    HyperRangeInt,
    HyperChoice,
    HyperMultipleChoice,
    HyperLogRangeFloat,
...
def test_HyperListOfDifferentSizes():
...
def test_addition_HyperComposition():
    ...
    #############################################
    ### Test 3 : Composition + update params ####
    #############################################

...
This is a copy of lightgbm sklearn wrapper with new functionnalities :
    * allowed internal CV to determine number of estimators
"""

import numpy as np

from lightgbm.basic import Dataset, LightGBMError, _ConfigAliases
from lightgbm.compat import (SKLEARN_INSTALLED, _LGBMClassifierBase,
...
from lightgbm.engine import train, cv
...
class LGBMModel(_LGBMModelBase):
    ...
    def __init__(self, boosting_type='gbdt', num_leaves=31, max_depth=-1,
        ...
        **kwargs
        ...
        self.cv_max_rounds=cv_max_rounds
        self.cv_early_stopping_rounds=cv_early_stopping_rounds
        self.cv_nfolds=cv_nfolds
        self.cv_folds=cv_folds
        self.cv_shuffle=cv_shuffle
        self.cv_stratified=cv_stratified
        self.cv_feval=cv_feval
    ...
    def fit(self, X, y,
        ...
        if self.do_crossvalidation:
            ...
            cv_results = cv(params, train_set,
                        num_boost_round=self.cv_max_rounds,
                        early_stopping_rounds=self.cv_early_stopping_rounds,
                        nfold=self.cv_nfolds,
                        folds=self.cv_folds,
            ...
            metric_name = [k for k in cv_results.keys() if 'mean' in k][-1]
        ...
        self._Booster = train(params, train_set,
                              n_estimators, valid_sets=valid_sets, valid_names=eval_names,
        ...
        ### AJOUT LIONEL ###
        elif self.do_crossvalidation:
            self._best_iteration = len(cv_results)

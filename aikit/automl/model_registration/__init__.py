...
try:
    ...
    lightgbm = None
    print("I wont be able to run AutoML on LighGBM models, please install lightgbm")
...
from aikit.automl.model_registration.utils import ModelRepresentationBase, register, _MODEL_REGISTER
